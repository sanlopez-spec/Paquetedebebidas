...
export default function Landing({ startWizard, onPrefetch }: LandingProps) {
    ...
    <div className="bg-edb-base text-edb-text min-h-screen">
      ...
      <main>
        ...
        <section
          ...
          aria-label="Hero"
        >
          {/* Hero content — Prompt 2 */}
          <p className="text-edb-muted text-sm">[Hero — próximo prompt]</p>
        </section>

        {/* ── SLOT: Fears ────── ¿Que falta o que sobre? */}
        {/* <FearsSection startWizard={startWizard} /> */}
        ...
        {/* ── SLOT: FinalCTA */}
        {/* <FinalCTASection startWizard={startWizard} /> */}
      </main>

      <Footer />
      <StickyCTA startWizard={startWizard} heroRef={heroRef} />
    </div>
  );
}
